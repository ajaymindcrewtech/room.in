        ...
        <div class="row">
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <?php // echo file_exists('../application/third_party/mpdf/mpdf.php') ? '' : '<small class="text-danger">mpdf required, download <a href="http://Vola.com">here</a></small>'; ?>
                                            </div>
                                        </div>-->
