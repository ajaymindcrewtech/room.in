...
public $image_path='';
 ...
 //$image_path=$_SERVER['DOCUMENT_ROOT']."images/product_images/";
    ...
    public static function saveFile($data, $name, $path = 'images/uploads/user/', $uid = true) {
	...
	public static function saveFile_admin($data, $name,  $path, $uid = true) {
//$path=$_SERVER['DOCUMENT_ROOT']."/shopee/images/product_images/";
        // Add trailing slash if omitted
        if (substr($path, -1) !== '/') {
            $path .= '/';
        }
	...
	public static function saveFile_Album($data, $name,  $path, $uid = true) {
