  ...
  <div class="row" id="vender_block" style="<?php echo $style; ?>">
    ...
    <div class="col-xs-6">
        ...
        <div class="form-group">
            ...
            <input type="post" class="form-control"  name="labour_cost" id="labour_cost" placeholder="labour cost" value="<?php echo $labour_cost; ?>">
          ...
          <div class="form-group">
            ...
            onclick="add_amount()" placeholder="Amount" value="<?php echo $amount; ?>" />
        </div>
